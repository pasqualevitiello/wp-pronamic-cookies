<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		<a class="nav-tab <?php if ( ! $tab ): ?>nav-tab-active<?php endif; ?>" href="<?php echo admin_url( 'options-general.php?page=pronamic_cookie_options_page' ); ?>"><?php echo esc_html( get_admin_page_title() ); ?></a>
